...
const ReviewWorkflow: React.FC<ReviewWorkflowProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-600 rounded-xl shadow-2xl p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-xl font-semibold text-white">Create Review Step</h2>
            <p className="text-sm text-gray-400 mt-1">
              Organize your changes into logical review units
            </p>
          </div>
          <button
            onClick={onClose}
